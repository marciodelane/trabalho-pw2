            ...
            <div class="container-fluid">
                <form action="#" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="email" id="email" class="form-control" value="<?php echo $usuario->getEmail();?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="senha" id="senha" class="form-control" value="<?php echo $usuario->getSenha();?>">
                    </div>
                    <div class="mb-3">
